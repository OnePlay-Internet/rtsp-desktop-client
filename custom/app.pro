...
win32 {
    contains(QT_ARCH, i386) {
        LIBS += -L$$PWD/../third-party/moonlight/libs/windows/lib/x86
        INCLUDEPATH += $$PWD/../third-party/moonlight/libs/windows/include/x86
    }
    ...
    contains(QT_ARCH, arm64) {
        ...
        INCLUDEPATH += $$PWD/../third-party/moonlight/libs/windows/include/arm64
    }
...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/moonlight-common-c/release/ -lmoonlight-common-c
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/moonlight-common-c/debug/ -lmoonlight-common-c
else:unix: LIBS += -L$$OUT_PWD/../third-party/moonlight/moonlight-common-c/ -lmoonlight-common-c

INCLUDEPATH += $$PWD/../third-party/moonlight/moonlight-common-c/moonlight-common-c/src
DEPENDPATH += $$PWD/../third-party/moonlight/moonlight-common-c/moonlight-common-c/src

win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/qmdnsengine/release/ -lqmdnsengine
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/qmdnsengine/debug/ -lqmdnsengine
else:unix: LIBS += -L$$OUT_PWD/../third-party/moonlight/qmdnsengine/ -lqmdnsengine

INCLUDEPATH += $$PWD/../third-party/moonlight/qmdnsengine/qmdnsengine/src/include $$PWD/../third-party/moonlight/qmdnsengine
DEPENDPATH += $$PWD/../third-party/moonlight/qmdnsengine/qmdnsengine/src/include $$PWD/../third-party/moonlight/qmdnsengine

soundio {
    win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/soundio/release/ -lsoundio
    else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/soundio/debug/ -lsoundio
    else:unix: LIBS += -L$$OUT_PWD/../third-party/moonlight/soundio/ -lsoundio

    INCLUDEPATH += $$PWD/../third-party/moonlight/soundio/libsoundio
    DEPENDPATH += $$PWD/../third-party/moonlight/soundio/libsoundio
}

win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/h264bitstream/release/ -lh264bitstream
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/h264bitstream/debug/ -lh264bitstream
else:unix: LIBS += -L$$OUT_PWD/../third-party/moonlight/h264bitstream/ -lh264bitstream

INCLUDEPATH += $$PWD/../third-party/moonlight/h264bitstream/h264bitstream
DEPENDPATH += $$PWD/../third-party/moonlight/h264bitstream/h264bitstream

!winrt {
    win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/AntiHooking/release/ -lAntiHooking
    else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../third-party/moonlight/AntiHooking/debug/ -lAntiHooking

    INCLUDEPATH += $$PWD/../third-party/moonlight/AntiHooking
    DEPENDPATH += $$PWD/../third-party/moonlight/AntiHooking
}
